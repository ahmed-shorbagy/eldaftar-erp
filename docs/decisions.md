...
| D25 | **Accepted 2026-09-24:** verified email is the Supabase Auth sign-in identifier and invitation acceptance must match that verified email. | Changes Auth, profile, recovery and admin subscriber identity | identity schema | implemented identifier: verified email; recovery uses Supabase Auth |
